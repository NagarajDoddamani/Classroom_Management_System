...
export default function SignUp() {
    ...
    const handelstep2 = () => {
        console.log("Navigating to Step 2 with data:", { UserName, useremail, userpassword, userConfirmpassword });
                ...
                <div className="flex-1 bg-white rounded-[40px] shadow-md px-10 py-8">
                    ...
                    <form className="space-y-6">
                        ...
                        <div>
                            ...
                            <input
                                type="password"
                                placeholder={userpassword ? userpassword : "Enter Your Password"}
                                className="w-full rounded-lg border border-[#c8d494] bg-[#f7ffd7] px-3 py-2 outline-none"
                                value={userpassword}
                    ...
                    <p className="text-xs text-center mt-4">
                        Already Have Account?{" "}
                        <Link to="/" className="text-red-600 font-semibold">Login...</Link>
                    </p>
